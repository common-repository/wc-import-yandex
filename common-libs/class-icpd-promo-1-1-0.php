	...
	final class ICPD_Promo {
		...
		public function __construct( $pref = '' ) {
			...
			$plugins_arr = [ 
				[ 
					...
					'desc' => __( 'Сreates a XML-feed to upload to Google Merchant Center', 'wc-import-yandex' ),
				...
				[ 
					...
					'desc' => __( 'Imports products from YML to your shop', 'wc-import-yandex' ),
				...
				[ 
					...
					'desc' => __( 'Сreates a XML-feed for importing your products to Hotline', 'wc-import-yandex' ),
				...
				[ 
					'name' => 'XML for Avito',
					'desc' => __( 'Сreates a XML-feed for importing your products to', 'wc-import-yandex' ),
		...
		public function print_view_html_plugins_list_block( $pref ) {
			...
			<div class="metabox-holder">
				<div class="postbox">
					<h2 class="hndle">
						<?php esc_html_e( 'My plugins that may interest you', 'wc-import-yandex' ); ?>
					</h2>
					<div class="inside">
						<?php
		...
		private function print_view_html_plugins_list_item( $data_arr ) {
			printf( '<p><span class="icpd_bold">%1$s</span> - %2$s. <a href="%3$s" target="_blank">%4$s</a>.</p>%5$s',
				...
				esc_html__( 'Read more', 'wc-import-yandex' ),
				PHP_EOL
			);
		}
